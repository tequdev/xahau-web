...
| `PreviousFields`    | Object                    | Los valores anteriores de todos los campos del objeto que fueron cambiados como resultado de esta transacción. Si la transacción *solo añadió* campos al objeto, este campo es un objeto vacío.                                                                                                          |
| `PreviousTxnID`     | String - [Hash][]         | *(Puede omitirse)* El [hash identificador][] de la transacción anterior que modificó este objeto de ledger. Omitido para tipos de objetos de ledger que no tienen un campo `PreviousTxnID`.                                                                                                              |
| `PreviousTxnLgrSeq` | Number - [Ledger Index][] | *(Puede omitirse)* El [Ledger Index][] de la versión del ledger que contiene la transacción anterior que modificó este objeto de ledger. Omitido para tipos de objetos de ledger que no tienen un campo `PreviousTxnLgrSeq`.                                                                             |
