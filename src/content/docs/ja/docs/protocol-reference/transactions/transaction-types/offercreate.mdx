---
title: OfferCreate
description: An OfferCreate transaction places an Offer in the decentralized exchange.
---
...
| `OfferSequence` | Number                                                                                               | UInt32            | *(Optional)* An Offer to delete first, specified in the same way as [OfferCancel][].                |
