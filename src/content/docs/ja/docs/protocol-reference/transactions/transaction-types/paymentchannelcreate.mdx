...
description: Create a payment channel and fund it with an Amount. The address sending this transaction becomes the "source address" of the payment channel.
---
